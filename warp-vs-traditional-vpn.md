...
- ایکس سرویس‌هایی مانند Tor، open proxies، و VPSهای کوچک را احتمالا به عنوان VPN/anonymous network تشخیص می‌دهد. این تشخیص بر اساس دیتابیس‌ها و reputation system مثل Tor exit node list، IP ranges مشخص شده در دیتابیس‌های open proxy و IPهای دیتاسنترهای ناشناس با reputation پایین انجام می‌شود. در نتیجه آی‌پی‌های کلودفلر در این دیتابیس‌ها قرار ندارند و reputation بالایی دارند، پس به‌عنوان VPN دسته‌بندی نمی‌شوند.
